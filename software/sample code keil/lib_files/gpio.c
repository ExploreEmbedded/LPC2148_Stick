...
void GPIO_PinFunction(gpioPins_et enm_pinNumber, uint8_t var_pinFunction_u8)
{
    ...
    {
    case 0:  PINSEL0 &= ~(0x03UL << var_pinNumber_u8);
    PINSEL0 |= (((uint32_t)var_pinFunction_u8) << var_pinNumber_u8);
    break;
		  
    case 1:  PINSEL1 &= ~(0x03UL << var_pinNumber_u8);
    PINSEL1 |= (((uint32_t)var_pinFunction_u8) << var_pinNumber_u8);
    break;

    case 2:  PINSEL2 &= ~(0x03UL << var_pinNumber_u8);
    PINSEL2 |= (((uint32_t)var_pinFunction_u8) << var_pinNumber_u8);
    break;                 
...
void GPIO_PinDirection(gpioPins_et enm_pinNumber, uint8_t var_pinDirn_u8)
{
    ...
    switch(var_portNumber_u8)
    {
    case 0:  util_UpdateBit(IO0DIR,var_pinNumber_u8,var_pinDirn_u8);
    break;
		   
    case 1:  util_UpdateBit(IO1DIR,(var_pinNumber_u8+16),var_pinDirn_u8);
    break;               
...
void GPIO_PinWrite(gpioPins_et enm_pinNumber, uint8_t var_pinValue_u8)
{
    ...
    switch(var_portNumber_u8)
    {
    case 0:  util_UpdateBit(IO0PIN,var_pinNumber_u8,var_pinValue_u8);
    break;
	   
    case 1:  util_UpdateBit(IO1PIN,(var_pinNumber_u8+16),var_pinValue_u8);
    break;              
...
uint8_t GPIO_PinRead(gpioPins_et enm_pinNumber)
{
    ...
    switch(var_portNumber_u8)
    {
    case 0:  returnStatus = util_IsBitSet(IO0PIN,var_pinNumber_u8);
    break; 

    case 1:  returnStatus = util_IsBitSet(IO1PIN,(var_pinNumber_u8+16));
    break;           
