/***************************************************************************************************
                                   ExploreEmbedded    
 ****************************************************************************************************
 * File:   uart.c (LPC214x controllers)
 * Version: 15.0
...
void UART_SetBaudRate(uint8_t var_uartChannel_u8, uint32_t var_baudRate_u32)
{
    ...
    {
    case 0:
        var_regValue_u32 = M_GetBaudRateGeneratorValue(var_baudRate_u32);
        U0DLL = (uint8_t) var_regValue_u32 & 0xff;            /* Lower 8bit baud rate generator value*/
        U0DLM = (uint8_t) (var_regValue_u32 >> 0x08) & 0xff;  /* Higher 8bit baud rate generator value*/
        break;


    case 1:
        var_regValue_u32 = M_GetBaudRateGeneratorValue(var_baudRate_u32);
        U1DLL = var_regValue_u32 & 0xff;            /* Lower 8bit baud rate generator value*/
        U1DLM = (var_regValue_u32 >> 0x08) & 0xff;  /* Higher 8bit baud rate generator value*/
        break;
    }
}
